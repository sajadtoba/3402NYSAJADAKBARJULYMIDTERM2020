...
public abstract class AbstractEmployee1 implements Employee1 {
    ...
    public abstract double overTimeCalculation (int extraHours);        //  nonly declared abstract mehtod but we must need java key word Abstract after the access modifier
